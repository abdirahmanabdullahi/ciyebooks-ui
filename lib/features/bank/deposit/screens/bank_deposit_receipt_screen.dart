...
class BankDepositReceiptScreen extends StatelessWidget {
  const BankDepositReceiptScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppbar(
        title: const Text("Cash deposit receipt"),
        actions: [
          IconButton(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ListTile(
                              ...
                              subtitle: Text("Currency deposited"),
                            ),
                            ListTile(
                              dense: true,
                              minTileHeight: 30,
