...
class DepositForClientForm extends StatelessWidget {
  const DepositForClientForm({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final controller = Get.put(DepositForClientController());
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  Text(controller.depositedCurrency.text, style: TextStyle(color: Colors.black87, fontWeight: FontWeight.w600)),
                                                ],
                                              ),
                                              Gap(5),
                                              Divider(thickness: 1, color: Colors.grey[300]),
