                ...
                children: [
                  Column(
                    children: [
                      ...
                      Gap(customHeight / 1.5),
                      // FloatingActionButton(onPressed: (){                                Get.offAll(()=>Test());
                      // }),
                      Row(
                        children: [
                          Expanded(
                            child: Padding(
                              ...
                              child: TextFormField(keyboardType: TextInputType.none,
                                ...
                                // onChanged: (value) {
                                //   controller.onChangedAmount(value);
                                // },
                                                  ...
                                                  children: [
                                                    ...
                                                    Row(
                                                      children: [
                                                        ...
                                                        Text(formatter.format(double.parse(controller.amountController.text)), style: TextStyle(color: Colors.black87, fontWeight: FontWeight.w600)),
                                                      ],
                                                    ),
                                                    Gap(5),
                                                    Divider(thickness: 1, color: Colors.grey[300]),
