...
class NewCurrencyController extends GetxController {
  ...
  fetchTotals() async {
    DocumentSnapshot balances = await FirebaseFirestore.instance.collection('Users').doc(uid).collection('Setup').doc('Balances').get();
  ...
  Future<void> addAllCurrencies() async {
    try {
      ...
      Get.snackbar('Hurray!', 'Currencies created', backgroundColor: Colors.green, colorText: Colors.white);
    } catch (e) {
