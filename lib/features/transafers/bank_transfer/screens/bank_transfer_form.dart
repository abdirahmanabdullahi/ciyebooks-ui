  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(automaticallyImplyLeading: true, leading: IconButton(
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Obx(
                      () => DropdownMenu(
                    controller: controller.transferringAccountNo,
                    trailingIcon: Icon(
                      Icons.search,
                    ...
                    label: Text('Transferring account'),
                    selectedTrailingIcon: Icon(Icons.search),
                    width: double.maxFinite,
                    onSelected: (value) {
                      if (value != null) {
                        controller.transferringAccountName.text = value[2].toString();
                        controller.transferringAccountNo.text = value[0].toString();
              ...
              Padding(
                ...
                child: Obx(
                    ...
                    onSelected: (value) {
                      print(value);
                      if (value != null) {
                        controller.transferredCurrency.text = value;
                      }
                    },
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 8.0),
                child:TextFormField(controller: controller.receiverName,)
              ),
              Gap(15),
              Padding(
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  controller: controller.transferredAmount,
                          ...
                          child: Obx(()=>
                              ElevatedButton(
                                ...
                                onPressed:controller.isButtonEnabled.value? (){
                                  print(controller.isButtonEnabled.value);
                                  showDialog(
                                    context: context,
                                    builder: (context) {
                                      return AlertDialog(
                                                ...
                                                children: [
                                                  Row(
                                                    children: [
                                                      ...
                                                      Text('Internal transfer', style: TextStyle(color: Colors.black87, fontWeight: FontWeight.w600)),
                                                    ],
                                                  ),
                                                  Gap(5),
                                                  ...
                                                  Row(
                                                    children: [
                                                      ...
                                                      // Text(controller.from.text, style: TextStyle(color: Colors.black87, fontWeight: FontWeight.w600)),
                                                    ],
                                                  ),
                                                  Gap(5),
                                                  Divider(thickness: 1, color: Colors.grey[300]),
                                                ...
                                                children: [
                                                  SizedBox(
                                                    ...
                                                    child: Obx(
                                                          ...
                                                          onPressed: controller.isLoading.value ? null : () => controller.createBankTransfer(context),
                                                          child: Text(
                                                            'Pay',
